...
![Mosaic Stitched Imagery](images/image26.gif) *Figure: Multiple images of the same location stitched together to form a complete scene. Source: [blog.maxar.com](https://blog.maxar.com)*
...
![Atmospheric Interaction and Spectral Signatures](images/spectra.png) *Figure 1: Atmospheric constraints on spectral capture. [@hong2026]*
...
![Resolution Trade-offs and Data Fusion](images/pipeline.png) *Figure 2: Comparative analysis of sensor resolutions. [@hong2026]*
...
![From Radiance to Analysis-Ready Data](images/scan.png) *Figure 3: The preprocessing transition to BOA. [@hong2026]*
...
![Feature Space and Object-Based Classification](images/hyper.png) *Figure 4: Machine learning and OBIA workflows. [@hong2026]*
...
![Validation Metrics and Spatial Autocorrelation](images/hsipng.png) *Figure 5: Rigorous accuracy assessment. [@hong2026]*
...
![Policy-Driven Predictive Modeling](images/fianl.png) *Figure 6: Global synthesis and urban intervention. [@hong2026]*

...
![ISODATA Clustering Analysis](images/ISODATA-1.jpg)
...
![Flow chart of the ISODATA model](images/isodata.png)
...
> [!IMPORTANT]
> **Core Principle: Maximum Likelihood**
> 
> The algorithm used by the Maximum Likelihood Classification tool is based on two fundamental principles:
> - **Normal Distribution**: The cells in each class sample in the multidimensional space are assumed to be normally distributed.
> - **Bayes' Theorem**: Utilizing Bayesian decision-making to assign pixels to the class with the highest probability.
...
![SVM Maximum Margin Illustration](images/svm.png)
...
![OBIA Segmentation](images/OBIA-Segmentation.jpg)
...
![OBIA Classification](images/OBIA-Classification-Final.jpg)
...
> 1. **SEGMENTATION**: Breaking the image into objects that represent real-world features.
> 2. **CLASSIFICATION**: Assigning categories based on spatial, spectral, and geometric attributes.
...
![Remote Sensing Trends](images/remote-sensing-trends.png)
